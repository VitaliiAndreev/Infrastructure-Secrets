...
#   duplicating the PS 5.1-compatible Get-Member + IsNullOrWhiteSpace loop.
#
#   Parameters:
#     Object  - the PSCustomObject to validate (e.g. a single VM entry)
#     Fields  - array of field names that must be present and non-empty
#     Context - string used in error messages (e.g. "VM 'ubuntu-01-ci'")
#
#   Example:
